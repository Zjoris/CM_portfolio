...
Tempo estimation{.storyboard}
===============================================================================


```{r eval=FALSE, include=FALSE}
blaNight <- get_tidy_audio_analysis("4Am0Hjzk17bVolHRiKtaPy")
...
```{r eval=FALSE, include=FALSE}
get_my_recently_played(limit=50,after= 	1611064958) %>% 
...
```{r eval=FALSE, include=FALSE}
dist(tracks_cluster, method = "manhattan") %>% 
